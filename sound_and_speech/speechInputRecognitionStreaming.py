...
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = "YOUR_GOOGLE_AUTHORISATION_JSON_FILE"
...
class MicrophoneStream(object):
    _soundSettings = {
        MicrophoneStreamInputSource.Microphone: MicrophoneStreamSettings(numChannels=1, rate=16000),
